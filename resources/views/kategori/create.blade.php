                ...
                <form action="{{ route('kategori.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex gap-2">
                            <button type="button"
                                class="btn rounded-circle d-flex align-items-center justify-content-center warna-pilih {{ old('warna', 'success') === 'success' ? 'ring-selected' : '' }}"
                                data-warna="success"
                                style="width: 42px; height: 42px; background-color: #198754; border: 3px solid transparent;">
                                <i
                                    class="bi bi-check-lg text-white {{ old('warna', 'success') === 'success' ? '' : 'd-none' }}"></i>
                            </button>
                            <button type="button"
                                class="btn rounded-circle d-flex align-items-center justify-content-center warna-pilih {{ old('warna', 'success') === 'danger' ? 'ring-selected' : '' }}"
                                data-warna="danger"
                                style="width: 42px; height: 42px; background-color: #dc3545; border: 3px solid transparent;">
                                <i
                                    class="bi bi-check-lg text-white {{ old('warna', 'success') === 'danger' ? '' : 'd-none' }}"></i>
                            </button>
                        </div>
                    </div>
